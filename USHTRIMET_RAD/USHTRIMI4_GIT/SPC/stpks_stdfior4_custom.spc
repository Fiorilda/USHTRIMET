CREATE OR REPLACE PACKAGE  stpks_stdfior4_custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdfior4_custom.spc
  **
...
/
CREATE OR REPLACE SYNONYM stpkss_stdfior4_custom FOR stpks_stdfior4_custom
/