CREATE OR REPLACE PACKAGE  stpks_stdfior4_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdfior4_main.spc
  **
...
TYPE ty_tb_v_sttms_fiori4_detail IS TABLE OF sttm_fiori4_detail%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdfior4 IS RECORD (
     v_sttms_fiori4_master     sttm_fiori4_master%ROWTYPE,
     v_sttms_fiori4_detail    ty_tb_v_sttms_fiori4_detail,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdfior4_main FOR stpks_stdfior4_main
/