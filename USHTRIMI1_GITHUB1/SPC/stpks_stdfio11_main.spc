CREATE OR REPLACE PACKAGE  stpks_stdfio11_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdfio11_main.spc
  **
...
TYPE ty_stdfio11 IS RECORD (
     v_sttms_fiori1_master     sttm_fiori1_master%ROWTYPE,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdfio11_main FOR stpks_stdfio11_main
/