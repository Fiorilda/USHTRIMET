CREATE OR REPLACE PACKAGE BODY stpks_stdfio11_main AS
     /*-----------------------------------------------------------------------------------------------------
     **
     ** File Name  : stpks_stdfio11_main.sql
     **
   ...
   g_Ui_Name            VARCHAR2(50) := 'STDFIO11';
   g_stdfio11         stpks_stdfio11_Main.ty_stdfio11;
   ...
   BEGIN
      stpks_stdfio11_Custom.Pr_Skip_Handler (P_Stage);
   END Pr_Skip_Handler;
   ...
   FUNCTION Fn_Sys_Build_Fc_Type (p_Source    IN     VARCHAR2,
      ...
      p_stdfio11       IN   OUT stpks_stdfio11_Main.ty_stdfio11,
   ...
   BEGIN
      ...
      LOOP
         ...
         IF  l_Node = 'BLK_GROUP' THEN
            p_stdfio11.v_sttms_fiori1_master.DESCRIPTION := Cspks_Req_Global.Fn_GetVal;
            p_stdfio11.v_sttms_fiori1_master.EXPOSURE_CATEGORY := Cspks_Req_Global.Fn_GetVal;
            p_stdfio11.v_sttms_fiori1_master.GROUP_CODE := Cspks_Req_Global.Fn_GetVal;
            p_stdfio11.v_sttms_fiori1_master.GROUP_STATUS := Cspks_Req_Global.Fn_GetVal;
            p_stdfio11.v_sttms_fiori1_master.GROUP_TYPE := Cspks_Req_Global.Fn_GetVal;
            l_Val       := Cspks_Req_Global.Fn_GetVal;
            IF Length(l_Val) > Length(Cspks_Req_Global.g_Date_Format) THEN
               p_stdfio11.v_sttms_fiori1_master.SINCE := TO_DATE(l_val,Cspks_Req_Global.g_Date_Time_Format);
            ELSE
               p_stdfio11.v_sttms_fiori1_master.SINCE := TO_DATE(l_val,Cspks_Req_Global.g_Date_Format);
            END IF;
            p_stdfio11.v_sttms_fiori1_master.MAKER_ID := Cspks_Req_Global.Fn_GetVal;
            l_Val       := Cspks_Req_Global.Fn_GetVal;
            IF Length(l_Val) > Length(Cspks_Req_Global.g_Date_Format) THEN
               p_stdfio11.v_sttms_fiori1_master.MAKER_DT_STAMP := TO_DATE(l_val,Cspks_Req_Global.g_Date_Time_Format);
            ELSE
               p_stdfio11.v_sttms_fiori1_master.MAKER_DT_STAMP := TO_DATE(l_val,Cspks_Req_Global.g_Date_Format);
            END IF;
            p_stdfio11.v_sttms_fiori1_master.CHECKER_ID := Cspks_Req_Global.Fn_GetVal;
            l_Val       := Cspks_Req_Global.Fn_GetVal;
            IF Length(l_Val) > Length(Cspks_Req_Global.g_Date_Format) THEN
               p_stdfio11.v_sttms_fiori1_master.CHECKER_DT_STAMP := TO_DATE(l_val,Cspks_Req_Global.g_Date_Time_Format);
            ELSE
               p_stdfio11.v_sttms_fiori1_master.CHECKER_DT_STAMP := TO_DATE(l_val,Cspks_Req_Global.g_Date_Format);
            END IF;
            p_stdfio11.v_sttms_fiori1_master.MOD_NO := Cspks_Req_Global.Fn_GetVal;
            p_stdfio11.v_sttms_fiori1_master.RECORD_STAT := Cspks_Req_Global.Fn_GetVal;
            p_stdfio11.v_sttms_fiori1_master.AUTH_STAT := Cspks_Req_Global.Fn_GetVal;
            p_stdfio11.v_sttms_fiori1_master.ONCE_AUTH := Cspks_Req_Global.Fn_GetVal;
         END IF;
         l_Node := Cspks_Req_Global.Fn_GetNode;
      END LOOP;

      p_stdfio11.Addl_Info := p_Addl_Info;
      Dbg('Returning Success From Fn_Sys_Build_Fc_Type.. ');
      RETURN TRUE;

   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdfio11_Main.Fn_Sys_Build_Fc_Type ');
         ...
         IF  l_Node IN ( 'BLK_GROUP','Group-Full','Group-IO') THEN
            ...
            LOOP
               ...
               IF l_Key = 'DESCRIPTION' THEN
                  p_stdfio11.v_sttms_fiori1_master.DESCRIPTION := l_Val;
               ELSIF l_Key = 'EXPOSURE_CATEGORY' THEN
                  p_stdfio11.v_sttms_fiori1_master.EXPOSURE_CATEGORY := l_Val;
               ELSIF l_Key = 'GROUP_CODE' THEN
                  p_stdfio11.v_sttms_fiori1_master.GROUP_CODE := l_Val;
               ELSIF l_Key = 'GROUP_STATUS' THEN
                  p_stdfio11.v_sttms_fiori1_master.GROUP_STATUS := l_Val;
               ELSIF l_Key = 'GROUP_TYPE' THEN
                  p_stdfio11.v_sttms_fiori1_master.GROUP_TYPE := l_Val;
               ...
               ELSIF l_Key = 'MAKER' THEN
                  p_stdfio11.v_sttms_fiori1_master.MAKER_ID := l_Val;
               ...
               ELSIF l_Key = 'CHECKER' THEN
                  p_stdfio11.v_sttms_fiori1_master.CHECKER_ID := l_Val;
               ...
               ELSIF l_Key = 'MODNO' THEN
                  p_stdfio11.v_sttms_fiori1_master.MOD_NO := l_Val;
               ELSIF l_Key = 'TXNSTAT' THEN
                  p_stdfio11.v_sttms_fiori1_master.RECORD_STAT := l_Val;
               ELSIF l_Key = 'AUTHSTAT' THEN
                  p_stdfio11.v_sttms_fiori1_master.AUTH_STAT := l_Val;
               ELSIF l_Key = 'ONCEAUTH' THEN
                  p_stdfio11.v_sttms_fiori1_master.ONCE_AUTH := l_Val;
               END IF;
               l_Key       := Cspks_Req_Global.Fn_GetTag;
               l_Val       := Cspks_Req_Global.Fn_GetVal;
            END LOOP;
   ...
   FUNCTION Fn_Sys_Build_Fc_Ts (p_Source    IN     VARCHAR2,
                              ...
                              p_Function_Id       IN     VARCHAR2,
                              p_Action_Code       IN     VARCHAR2,
      p_stdfio11          IN stpks_stdfio11_Main.ty_stdfio11,
      p_Err_Code        IN OUT VARCHAR2,
      p_Err_Params      IN OUT VARCHAR2)
   RETURN BOOLEAN   IS
   ...
   BEGIN
      ...
      Cspks_Req_Global.Pr_Write('V','DESCRIPTION',p_stdfio11.v_sttms_fiori1_master.description);
      Cspks_Req_Global.Pr_Write('V','EXPOSURE_CATEGORY',p_stdfio11.v_sttms_fiori1_master.exposure_category);
      Cspks_Req_Global.Pr_Write('V','GROUP_CODE',p_stdfio11.v_sttms_fiori1_master.group_code);
      Cspks_Req_Global.Pr_Write('V','GROUP_STATUS',p_stdfio11.v_sttms_fiori1_master.group_status);
      Cspks_Req_Global.Pr_Write('V','GROUP_TYPE',p_stdfio11.v_sttms_fiori1_master.group_type);
      IF trunc(p_stdfio11.v_sttms_fiori1_master.since) <>
            p_stdfio11.v_sttms_fiori1_master.since THEN
         l_Date_Val :=  TO_CHAR( p_stdfio11.v_sttms_fiori1_master.since,Cspks_Req_Global.g_Ws_Date_Time_Format);
      ELSE
         l_Date_Val :=  TO_CHAR( p_stdfio11.v_sttms_fiori1_master.since,Cspks_Req_Global.g_Ws_Date_Format);
      END IF;
      Cspks_Req_Global.Pr_Write('V','SINCE',l_Date_Val);
      Cspks_Req_Global.Pr_Write('V','MAKER',p_stdfio11.v_sttms_fiori1_master.maker_id);
      IF trunc(p_stdfio11.v_sttms_fiori1_master.maker_dt_stamp) <>
            p_stdfio11.v_sttms_fiori1_master.maker_dt_stamp THEN
         l_Date_Val :=  TO_CHAR( p_stdfio11.v_sttms_fiori1_master.maker_dt_stamp,Cspks_Req_Global.g_Ws_Date_Time_Format);
      ELSE
         l_Date_Val :=  TO_CHAR( p_stdfio11.v_sttms_fiori1_master.maker_dt_stamp,Cspks_Req_Global.g_Ws_Date_Format);
      END IF;
      Cspks_Req_Global.Pr_Write('V','MAKERSTAMP',l_Date_Val);
      Cspks_Req_Global.Pr_Write('V','CHECKER',p_stdfio11.v_sttms_fiori1_master.checker_id);
      IF trunc(p_stdfio11.v_sttms_fiori1_master.checker_dt_stamp) <>
            p_stdfio11.v_sttms_fiori1_master.checker_dt_stamp THEN
         l_Date_Val :=  TO_CHAR( p_stdfio11.v_sttms_fiori1_master.checker_dt_stamp,Cspks_Req_Global.g_Ws_Date_Time_Format);
      ELSE
         l_Date_Val :=  TO_CHAR( p_stdfio11.v_sttms_fiori1_master.checker_dt_stamp,Cspks_Req_Global.g_Ws_Date_Format);
      END IF;
      Cspks_Req_Global.Pr_Write('V','CHECKERSTAMP',l_Date_Val);
      Cspks_Req_Global.Pr_Write('V','MODNO',p_stdfio11.v_sttms_fiori1_master.mod_no);
      Cspks_Req_Global.Pr_Write('V','TXNSTAT',p_stdfio11.v_sttms_fiori1_master.record_stat);
      Cspks_Req_Global.Pr_Write('V','AUTHSTAT',p_stdfio11.v_sttms_fiori1_master.auth_stat);
      Cspks_Req_Global.Pr_Write('V','ONCEAUTH',p_stdfio11.v_sttms_fiori1_master.once_auth);
   ...
   BEGIN
      ...
      IF SUBSTR(p_Exchange_Pattern,3,4) = 'FS' THEN
         ...
         --Dbg('Building Childs Of :..');
         IF (  p_stdfio11.v_sttms_fiori1_master.group_code IS NOT NULL 
          )
          THEN
            l_0_Lvl_Counter   := l_0_Lvl_Counter +1;
            l_Level_Format      := l_0_Lvl_Counter;
      ...
      ELSE
         ...
         l_Key_Vals := p_stdfio11.v_sttms_fiori1_master.group_code||'~';
   ...
   BEGIN
      ...
      l_Fld := 'STTMS_FIORI1_MASTER.GROUP_CODE';
      IF p_stdfio11.v_sttms_fiori1_master.group_code IS Null THEN
   ...
   BEGIN
      ...
      IF p_stdfio11.v_sttms_fiori1_master.GROUP_TYPE IS NOT NULL THEN
         IF p_stdfio11.v_sttms_fiori1_master.GROUP_TYPE NOT IN ('LBL_CORPORATE','LBL_RETAIL_GROUP_TYPE','LBL_CHARGE','LBL_CLEARING','LBL_TAX') THEN
            dbg('Invalid Value For The Field  :GROUP_TYPE:'||p_stdfio11.v_sttms_fiori1_master.GROUP_TYPE);
            Pr_Log_Error(p_Source,'ST-VALS-011',p_stdfio11.v_sttms_fiori1_master.GROUP_TYPE||'~@STTMS_FIORI1_MASTER.GROUP_TYPE~@STTMS_FIORI1_MASTER') ;
         END IF;
      END IF;
   ...
   FUNCTION Fn_Sys_Default_Vals        (p_Source            IN VARCHAR2,
      p_Wrk_stdfio11     IN  OUT stpks_stdfio11_Main.ty_stdfio11,
      p_Err_Code          IN OUT VARCHAR2,
      p_Err_Params        IN OUT VARCHAR2)
   RETURN BOOLEAN   IS
   ...
   BEGIN
      ...
      IF p_Wrk_stdfio11.v_sttms_fiori1_master.GROUP_TYPE IS NULL THEN
         p_Wrk_stdfio11.v_sttms_fiori1_master.GROUP_TYPE := 'LBL_CORPORATE';
      END IF;
   ...
   FUNCTION Fn_Sys_Merge_Amendables        (p_Source            IN VARCHAR2,
      p_Source_Operation  IN     VARCHAR2,
      p_stdfio11     IN  stpks_stdfio11_Main.Ty_stdfio11,
      p_Prev_stdfio11 IN stpks_stdfio11_Main.Ty_stdfio11,
      p_Wrk_stdfio11 IN OUT stpks_stdfio11_Main.Ty_stdfio11,
      p_Err_Code          IN OUT VARCHAR2,
      p_Err_Params        IN OUT VARCHAR2)
   RETURN BOOLEAN   IS
   ...
   BEGIN
      ...
      l_fld := 'STTMS_FIORI1_MASTER.DESCRIPTION';
      IF Fn_Amendable('STTMS_FIORI1_MASTER.DESCRIPTION') THEN
         p_Wrk_stdfio11.v_sttms_fiori1_master.description := p_stdfio11.v_sttms_fiori1_master.description;
      ELSE
         IF p_stdfio11.v_sttms_fiori1_master.description IS NOT NULL THEN
            IF NVL(p_Wrk_stdfio11.v_sttms_fiori1_master.description,'@') <>
               NVL(p_stdfio11.v_sttms_fiori1_master.description,'@')  THEN
               l_Modified_Flds := l_Modified_Flds ||'~'||l_Fld;
               l_Rec_Modified := TRUE;
            END IF;
         END IF;
      END IF;
      l_fld := 'STTMS_FIORI1_MASTER.EXPOSURE_CATEGORY';
      IF Fn_Amendable('STTMS_FIORI1_MASTER.EXPOSURE_CATEGORY') THEN
         p_Wrk_stdfio11.v_sttms_fiori1_master.exposure_category := p_stdfio11.v_sttms_fiori1_master.exposure_category;
      ELSE
         IF p_stdfio11.v_sttms_fiori1_master.exposure_category IS NOT NULL THEN
            IF NVL(p_Wrk_stdfio11.v_sttms_fiori1_master.exposure_category,'@') <>
               NVL(p_stdfio11.v_sttms_fiori1_master.exposure_category,'@')  THEN
               l_Modified_Flds := l_Modified_Flds ||'~'||l_Fld;
               l_Rec_Modified := TRUE;
            END IF;
         END IF;
      END IF;
      l_fld := 'STTMS_FIORI1_MASTER.GROUP_STATUS';
      IF Fn_Amendable('STTMS_FIORI1_MASTER.GROUP_STATUS') THEN
         p_Wrk_stdfio11.v_sttms_fiori1_master.group_status := p_stdfio11.v_sttms_fiori1_master.group_status;
      ELSE
         IF p_stdfio11.v_sttms_fiori1_master.group_status IS NOT NULL THEN
            IF NVL(p_Wrk_stdfio11.v_sttms_fiori1_master.group_status,'@') <>
               NVL(p_stdfio11.v_sttms_fiori1_master.group_status,'@')  THEN
               l_Modified_Flds := l_Modified_Flds ||'~'||l_Fld;
               l_Rec_Modified := TRUE;
            END IF;
         END IF;
      END IF;
      l_fld := 'STTMS_FIORI1_MASTER.GROUP_TYPE';
      IF Fn_Amendable('STTMS_FIORI1_MASTER.GROUP_TYPE') THEN
         p_Wrk_stdfio11.v_sttms_fiori1_master.group_type := p_stdfio11.v_sttms_fiori1_master.group_type;
      ELSE
         IF p_stdfio11.v_sttms_fiori1_master.group_type IS NOT NULL THEN
            IF NVL(p_Wrk_stdfio11.v_sttms_fiori1_master.group_type,'@') <>
               NVL(p_stdfio11.v_sttms_fiori1_master.group_type,'@')  THEN
               l_Modified_Flds := l_Modified_Flds ||'~'||l_Fld;
               l_Rec_Modified := TRUE;
            END IF;
         END IF;
      END IF;
      l_fld := 'STTMS_FIORI1_MASTER.SINCE';
      IF Fn_Amendable('STTMS_FIORI1_MASTER.SINCE') THEN
         p_Wrk_stdfio11.v_sttms_fiori1_master.since := p_stdfio11.v_sttms_fiori1_master.since;
      ELSE
         IF p_stdfio11.v_sttms_fiori1_master.since IS NOT NULL THEN
            IF NVL(p_Wrk_stdfio11.v_sttms_fiori1_master.since,global.min_date) <>
               NVL(p_stdfio11.v_sttms_fiori1_master.since,global.min_date)  THEN
               l_Modified_Flds := l_Modified_Flds ||'~'||l_Fld;
               l_Rec_Modified := TRUE;
            END IF;
         END IF;
   ...
   FUNCTION Fn_Sys_Check_Mandatory_Nodes  (p_Source            IN VARCHAR2,
      p_Wrk_stdfio11 IN  stpks_stdfio11_Main.Ty_stdfio11,
      p_Err_Code          IN OUT VARCHAR2,
      p_Err_Params        IN OUT VARCHAR2)
   RETURN BOOLEAN   IS
   ...
   BEGIN
      ...
      l_Blk := 'STTMS_FIORI1_MASTER';
      l_Fld := 'STTMS_FIORI1_MASTER.EXPOSURE_CATEGORY';
      IF p_wrk_stdfio11.v_sttms_fiori1_master.EXPOSURE_CATEGORY IS NOT NULL THEN
         SELECT COUNT(*) INTO l_LOV_COUNT  FROM  (SELECT  DISTINCT CATEGORY_NAME FROM FIORI_CATEGORY) WHERE CATEGORY_NAME = P_wrk_stdfio11.v_sttms_fiori1_master.EXPOSURE_CATEGORY;
         IF l_lov_count = 0  THEN
            Dbg('Invalid Value For The Field  :EXPOSURE_CATEGORY:'||p_Wrk_stdfio11.v_sttms_fiori1_master.EXPOSURE_CATEGORY);
            Pr_Log_Error(p_Source,'ST-VALS-011',p_Wrk_stdfio11.v_sttms_fiori1_master.EXPOSURE_CATEGORY||'~@STTMS_FIORI1_MASTER.EXPOSURE_CATEGORY~@STTMS_FIORI1_MASTER') ;
         END IF;
      END IF;
   ...
   FUNCTION Fn_Sys_Default_And_Validate        (p_Source            IN VARCHAR2,
      ...
      p_Action_Code       IN     VARCHAR2,
      p_stdfio11     IN  stpks_stdfio11_Main.Ty_stdfio11,
      p_Prev_stdfio11 IN OUT  stpks_stdfio11_Main.Ty_stdfio11,
      p_Wrk_stdfio11 IN OUT  stpks_stdfio11_Main.Ty_stdfio11,
      p_Err_Code          IN OUT VARCHAR2,
      p_Err_Params        IN OUT VARCHAR2)
   RETURN BOOLEAN   IS
   ...
   BEGIN
      ...
      IF p_Source <> 'FLEXCUBE'  THEN
         ...
         END;
      END IF;
      l_key := Cspks_Req_Utils.Fn_Get_Item_Desc(p_source,g_ui_name,'STTMS_FIORI1_MASTER.GROUP_CODE')||'-'||
      p_stdfio11.v_sttms_fiori1_master.group_code;
      l_Prev_Key_Tags := 'GROUP_CODE~';
      l_Prev_Key_Vals := p_prev_stdfio11.v_sttms_fiori1_master.group_code||'~';
      Dbg('Calling Cspks_Req_Utils.Fn_Maint_Basic_Validations..');
      IF NOT Cspks_Req_Utils.Fn_Maint_Basic_Validations (p_source,
         p_Source_Operation,
         p_Function_Id,
         p_Action_Code,
         p_Prev_stdfio11.v_sttms_fiori1_master.Mod_No,
         p_stdfio11.v_sttms_fiori1_master.Mod_No,
         p_Prev_stdfio11.v_sttms_fiori1_master.Auth_Stat,
         p_Prev_stdfio11.v_sttms_fiori1_master.Record_Stat,
         p_Prev_stdfio11.v_sttms_fiori1_master.Once_Auth,
         l_Prev_Key_Tags,
         l_Prev_Key_Vals,
         g_Key_Id,
         l_Key,
      ...
      IF ( p_Action_Code IN (Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen,Cspks_Req_Global.p_Delete,Cspks_Req_Global.p_Version_Delete,Cspks_Req_Global.p_Query) OR
            ( p_Action_Code = Cspks_Req_Global.p_Modify AND NVL(p_Prev_stdfio11.v_sttms_fiori1_master.Once_Auth,'N') = 'Y')) THEN
         p_Wrk_stdfio11 := p_Prev_stdfio11;
         p_wrk_stdfio11.v_sttms_fiori1_master.Mod_No := p_stdfio11.v_sttms_fiori1_master.Mod_No;
         p_Wrk_stdfio11.Addl_Info := p_stdfio11.Addl_Info ;
      ELSE
         p_Wrk_stdfio11 := p_stdfio11;
      END IF;
      IF p_Action_Code = Cspks_Req_Global.p_Auth THEN
         IF p_Wrk_stdfio11.v_sttms_fiori1_master.Mod_No IS NULL THEN
            p_Wrk_stdfio11.v_sttms_fiori1_master.Mod_No           := p_prev_stdfio11.v_sttms_fiori1_master.Mod_No;
         END IF;
         p_Wrk_stdfio11.v_sttms_fiori1_master.Checker_dt_stamp   := fn_mntstamp;
         p_Wrk_stdfio11.v_sttms_fiori1_master.Checker_id         := Global.user_id;
      ELSIF p_Action_Code IN (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen) THEN
         p_Wrk_stdfio11.v_sttms_fiori1_master.Auth_Stat        := 'U';
         IF NOT Cspks_Req_Global.Fn_UnTanking THEN
            p_Wrk_stdfio11.v_sttms_fiori1_master.Maker_Id         := Global.User_Id;
            p_Wrk_stdfio11.v_sttms_fiori1_master.Maker_Dt_Stamp   := Fn_Mntstamp;
         ELSE
            p_Wrk_stdfio11.v_sttms_fiori1_master.Maker_Id         := NVL(p_stdfio11.v_sttms_fiori1_master.Maker_Id,Global.User_Id);
            p_Wrk_stdfio11.v_sttms_fiori1_master.Maker_Dt_Stamp   := NVL(p_stdfio11.v_sttms_fiori1_master.Maker_Dt_Stamp,Fn_Mntstamp);
         END IF;

         IF p_Action_Code = Cspks_Req_Global.p_New THEN
            IF NOT Cspks_Req_Global.Fn_UnTanking THEN
               p_Wrk_stdfio11.v_sttms_fiori1_master.Mod_No           := 1;
            ELSE
               p_Wrk_stdfio11.v_sttms_fiori1_master.Mod_No := NVL(p_Wrk_stdfio11.v_sttms_fiori1_master.Mod_No,1);
            END IF;
            p_Wrk_stdfio11.v_sttms_fiori1_master.Record_Stat      := 'O';
            p_Wrk_stdfio11.v_sttms_fiori1_master.Once_Auth        := 'N';
         ELSE
            IF NOT Cspks_Req_Global.Fn_UnTanking THEN
               p_wrk_stdfio11.v_sttms_fiori1_master.Mod_No           := NVL(p_prev_stdfio11.v_sttms_fiori1_master.Mod_No,0)+1;
            ELSE
               p_Wrk_stdfio11.v_sttms_fiori1_master.Mod_No           := NVL(p_stdfio11.v_sttms_fiori1_master.Mod_No,1);
            END IF;
            p_Wrk_stdfio11.v_sttms_fiori1_master.Once_Auth           := NVL(p_Prev_stdfio11.v_sttms_fiori1_master.Once_Auth,'N');
            p_wrk_stdfio11.v_sttms_fiori1_master.Record_Stat           := NVL(p_prev_stdfio11.v_sttms_fiori1_master.Record_Stat,'O');
         END IF;
         IF p_Action_Code = Cspks_Req_Global.p_Close THEN
            p_Wrk_stdfio11.v_sttms_fiori1_master.Record_Stat      := 'C';
         ELSIF p_Action_Code = Cspks_Req_Global.p_Reopen THEN
            p_Wrk_stdfio11.v_sttms_fiori1_master.Record_Stat      := 'O';
         END IF;
         p_Wrk_stdfio11.v_sttms_fiori1_master.Checker_id         := Null;
         p_Wrk_stdfio11.v_sttms_fiori1_master.Checker_Dt_Stamp         := Null;
      ...
      IF p_Action_Code in  (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify) THEN
         ...
         IF p_Action_Code = Cspks_Req_Global.p_New OR  ( p_Action_Code = Cspks_Req_Global.p_Modify AND p_Prev_stdfio11.v_sttms_fiori1_master.Once_Auth = 'N') THEN
         ...
         END IF;
         IF p_Action_Code = Cspks_Req_Global.p_Modify AND p_Prev_stdfio11.v_sttms_fiori1_master.Once_Auth = 'Y'THEN
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdfio11_Main.Fn_Sys_Default_And_Validate ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      ELSE
         ...
         IF NVL(p_With_Lock,'N') = 'Y' THEN
            BEGIN
               SELECT *
               INTO   p_wrk_stdfio11.v_sttms_fiori1_master
               FROM  STTM_FIORI1_MASTER
               WHERE group_code = p_stdfio11.v_sttms_fiori1_master.group_code
                FOR UPDATE NOWAIT;
            EXCEPTION
   ...
   BEGIN
      ...
      IF p_Action_Code = Cspks_Req_Global.p_new THEN
         ...
         Dbg('Inserting Into STTMS_FIORI1_MASTER..');
         BEGIN
            IF  p_wrk_stdfio11.v_sttms_fiori1_master.group_code IS NOT NULL THEN
               Dbg('Record Sent..');
               INSERT INTO  STTM_FIORI1_MASTER
               VALUES p_wrk_stdfio11.v_sttms_fiori1_master;
            END IF;
         EXCEPTION
            WHEN OTHERS THEN
               Dbg('Failed In Insert intoSTTMS_FIORI1_MASTER..');
               Dbg(SQLERRM);
               p_Err_Code    := 'ST-UPLD-001';
               p_Err_Params  := '@STTMS_FIORI1_MASTER';
               RETURN FALSE;
         END;
      ELSIF p_Action_Code = Cspks_Req_Global.p_modify THEN

         Dbg('Updating Single Record Node :  STTMS_FIORI1_MASTER..');
         BEGIN
            UPDATE STTM_FIORI1_MASTER
            SET
            DESCRIPTION = p_Wrk_stdfio11.v_sttms_fiori1_master.DESCRIPTION,
            EXPOSURE_CATEGORY = p_Wrk_stdfio11.v_sttms_fiori1_master.EXPOSURE_CATEGORY,
            GROUP_STATUS = p_Wrk_stdfio11.v_sttms_fiori1_master.GROUP_STATUS,
            GROUP_TYPE = p_Wrk_stdfio11.v_sttms_fiori1_master.GROUP_TYPE,
            SINCE = p_Wrk_stdfio11.v_sttms_fiori1_master.SINCE,
            MAKER_ID = p_Wrk_stdfio11.v_sttms_fiori1_master.MAKER_ID,
            MAKER_DT_STAMP = p_Wrk_stdfio11.v_sttms_fiori1_master.MAKER_DT_STAMP,
            CHECKER_ID = p_Wrk_stdfio11.v_sttms_fiori1_master.CHECKER_ID,
            CHECKER_DT_STAMP = p_Wrk_stdfio11.v_sttms_fiori1_master.CHECKER_DT_STAMP,
            MOD_NO = p_Wrk_stdfio11.v_sttms_fiori1_master.MOD_NO,
            RECORD_STAT = p_Wrk_stdfio11.v_sttms_fiori1_master.RECORD_STAT,
            AUTH_STAT = p_Wrk_stdfio11.v_sttms_fiori1_master.AUTH_STAT,
            ONCE_AUTH = p_Wrk_stdfio11.v_sttms_fiori1_master.ONCE_AUTH
WHERE group_code = p_Wrk_stdfio11.v_sttms_fiori1_master.group_code
;
         EXCEPTION
            WHEN OTHERS THEN
               Dbg('Failed in Insert Into STTMS_FIORI1_MASTER..');
               Dbg(SQLERRM);
               p_Err_Code    := 'ST-UPLD-001';
               p_Err_Params  := '@STTMS_FIORI1_MASTER';
               RETURN FALSE;
      ...
      ELSIF p_Action_Code = Cspks_Req_Global.p_delete THEN
         ...
         DELETE STTM_FIORI1_MASTER WHERE group_code = p_Wrk_stdfio11.v_sttms_fiori1_master.group_code
         ;


      ELSIF p_Action_Code IN (Cspks_Req_Global.p_Auth,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen ) THEN
         l_key := Cspks_Req_Utils.Fn_Get_Item_Desc(p_source,g_ui_name,'STTMS_FIORI1_MASTER.GROUP_CODE')||'-'||
         p_Wrk_stdfio11.v_sttms_fiori1_master.group_code;
         BEGIN
            SELECT ROWID
            INTO   l_row_id
            FROM  STTM_FIORI1_MASTER
         ...
         IF NOT Cspks_Req_Utils.Fn_Maint_Operations(p_Source,
            ...
            'STTM_FIORI1_MASTER',
            l_Row_Id,
            p_Wrk_stdfio11.v_sttms_fiori1_master.mod_no,
            p_Wrk_stdfio11.v_sttms_fiori1_master.Maker_dt_Stamp,
            p_Wrk_stdfio11.v_sttms_fiori1_master.Checker_dt_Stamp,
            g_Key_Id,
            l_Key,
            p_Err_Code,
            p_Err_params) THEN
   ...
   BEGIN
      ...
      IF NOT stpks_stdfio11_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdfio11_Custom.Fn_Post_Build_Type_Structure(p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            l_Child_Function,
            ...
            p_Err_Code,
            p_Err_Params)  THEN
            Dbg('Failed in stpks_stdfio11_Custom.Fn_Post_Build_Type_Structure..');
            RETURN FALSE;
         END IF;
      END IF;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdfio11_Main.Fn_Build_Type ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         debug.pr_debug('**','In when others of stpks_stdfio11_Main.Fn_Build_Ts_List ..');
         debug.pr_debug('**',SQLERRM);
         p_err_code    := 'ST-OTHR-001';
         p_err_params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      IF NOT Cspks_Req_Utils.Fn_Get_Key_Information(p_Source,
         ...
         l_Key_Cols,
         l_Key_Vals,
         p_stdfio11.Addl_Info,
         p_Err_Code,
         p_Err_Params) THEN
         Dbg('Failed in  Cspks_Req_Utils.Fn_Get_Key_Information..');
         RETURN FALSE;
      END IF;
      IF p_stdfio11.Addl_Info.EXISTS('RECORD_KEY') THEN
         G_Req_Key :=  p_stdfio11.Addl_Info('RECORD_KEY');
      END IF;
      IF p_stdfio11.Addl_Info.EXISTS('KEY_ID') THEN
         G_Key_Id :=  p_stdfio11.Addl_Info('KEY_ID');
      END IF;
      p_stdfio11.Addl_Info('SENT_MOD_NO') :=p_stdfio11.v_sttms_fiori1_master.Mod_No;
      Dbg('Returning Succsess From Fn_Get_Key_Information..');
      RETURN TRUE;

   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdfio11_Main.Fn_Get_Key_Information..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      IF NOT stpks_stdfio11_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdfio11_Custom.Fn_Pre_Check_Mandatory (p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params)  THEN
            Dbg('Failed in  stpks_stdfio11_Custom.Fn_Pre_Check_Mandatory..');
            RETURN FALSE;
         END IF;
      END IF;

      IF NOT stpks_stdfio11_Main.Fn_Skip_Sys THEN
      ...
      IF NOT stpks_stdfio11_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdfio11_Custom.Fn_Post_Check_Mandatory (p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params)  THEN
            Dbg('Failed in  stpks_stdfio11_Custom.Fn_Post_Check_Mandatory..');
            RETURN FALSE;
         END IF;
      END IF;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdfio11_Main.Fn_Check_Mandatory ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      l_Mod_No := p_stdfio11.v_sttms_fiori1_master.Mod_No;
      ...
      IF l_Tanked_data_Found THEN
         IF l_Bld_Type_From_Tanked_Data THEN
            ...
            stpks_stdfio11_Main.Pr_Set_Skip_custom;
            Pr_Skip_Handler('POSTTANKQRY');
            Dbg('Calling Post Query Hooks After Query Of Tanked Data');
            IF NOT stpks_stdfio11_Main.Fn_Skip_custom  THEN
               IF NOT stpks_stdfio11_Custom.Fn_Post_Query (p_Source,
                  p_Source_operation,
                  p_Function_id,
                  p_Action_Code,
                  p_Function_Id  ,
                  ...
                  p_Err_Code,
                  p_Err_Params) THEN
                  Dbg('Failed in stpks_stdfio11_Custom.Fn_Post_Query of Tanked Data');
                  RETURN FALSE;
               END IF;
            END IF;
      ...
      ELSE
         ...
         IF NOT stpks_stdfio11_Main.Fn_Skip_custom  THEN
            IF NOT stpks_stdfio11_Custom.Fn_Pre_Query (p_Source,
               p_Source_Operation,
               p_Function_Id,
               p_Action_Code,
               p_function_Id  ,
               ...
               p_Err_Code  ,
               p_Err_Params ) THEN
               Dbg('Failed in stpks_stdfio11_Custom.Fn_Pre_Query..');
               RETURN FALSE;
            END IF;
         END IF;
         IF NOT stpks_stdfio11_Main.Fn_Skip_Sys THEN
         ...
         IF NOT stpks_stdfio11_Main.Fn_Skip_custom  THEN
            IF NOT stpks_stdfio11_Custom.Fn_Post_Query (p_Source,
               ...
               p_Err_Code  ,
               p_Err_Params ) THEN
               Dbg('Failed in stpks_stdfio11_Custom.Fn_Post_Query..');
               RETURN FALSE;
            END IF;
         END IF;
      END IF;
   ...
   BEGIN
      ...
      IF NOT stpks_stdfio11_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdfio11_Custom.Fn_Pre_Default_And_Validate (p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params) THEN
            Dbg('Failed in stpks_stdfio11_Custom.Fn_Pre_Default_And_Validate..');
            RETURN FALSE;
         END IF;
      END IF;
      IF NOT stpks_stdfio11_Main.Fn_Skip_Sys THEN
      ...
      IF NOT stpks_stdfio11_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdfio11_Custom.Fn_Post_Default_And_Validate (p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params) THEN
            Dbg('Failed in stpks_stdfio11_Custom.Fn_Post_Default_And_Validate..');
            RETURN FALSE;
         END IF;
      END IF;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdfio11_Main.Fn_Default_And_Validate ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      IF NOT stpks_stdfio11_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdfio11_Custom.Fn_Pre_Upload_Db (p_Source,
            p_Source_operation,
            p_Function_id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params) THEN
            Dbg('Failed in stpks_stdfio11_Custom.Fn_Pre_Upload_Db..');
            RETURN FALSE;
         END IF;
      END IF;
      IF NOT stpks_stdfio11_Main.Fn_Skip_Sys THEN
      ...
      IF NOT stpks_stdfio11_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdfio11_Custom.Fn_Post_Upload_Db (p_Source,
            p_Source_operation,
            p_Function_id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params) THEN
            Dbg('Failed in stpks_stdfio11_Custom.Fn_Post_Upload_Db..');
            RETURN FALSE;
         END IF;
      END IF;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdfio11_Main.Fn_Upload_Db ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   RETURN BOOLEAN IS
      ...
      l_Summary_Rec     STTM_FIORI1_MASTER%ROWTYPE;
   ...
   BEGIN
      ...
      IF  p_Action_Code IN (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen) THEN
         ...
         IF g_Key_Id IS NOT NULL THEN
            l_Summary_Rec := p_stdfio11.v_sttms_fiori1_master;
   ...
   RETURN BOOLEAN IS
      ...
      l_wrk_stdfio11      stpks_stdfio11_Main.Ty_stdfio11;
      l_Skip_custom      BOOLEAN := FALSE;
      ...
      IF  p_Action_Code IN (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen,Cspks_Req_Global.p_Auth,Cspks_Req_Global.p_Delete,Cspks_Req_Global.p_Version_Delete) THEN
         ...
         IF l_Key_Id IS NOT NULL THEN
            IF p_Action_Code IN( Cspks_Req_Global.p_auth,Cspks_Req_Global.p_Delete,Cspks_Req_Global.p_Version_Delete) THEN
               IF p_stdfio11.v_sttms_fiori1_master.Mod_no IS NOT NULL THEN
                  l_Mod_No           := p_stdfio11.v_sttms_fiori1_master.Mod_No;
               ELSE
                  l_Mod_No           := p_Wrk_stdfio11.v_sttms_fiori1_master.Mod_No;
               END IF;
            ELSE
               l_mod_no           := p_wrk_stdfio11.v_sttms_fiori1_master.mod_no;
            END IF;
              l_Auth_Stat := NVL(p_Wrk_stdfio11.v_sttms_fiori1_master.Auth_Stat,'U') ;
            ...
            IF Cspks_Req_Utils.Fn_Field_Log_Reqd(p_Function_Id,p_Action_Code) THEN
               ...
               IF p_Prev_stdfio11.v_sttms_fiori1_master.group_code IS NOT NULL THEN
               ...
               IF l_Prev_Found   THEN
                  l_Dtl_key := '~STTM_FIORI1_MASTER~'||p_Prev_stdfio11.v_sttms_fiori1_master.group_code||'~';
               ELSIF l_Wrk_Found   THEN
                  l_Dtl_key := '~STTM_FIORI1_MASTER~'||p_Wrk_stdfio11.v_sttms_fiori1_master.group_code||'~';
               END IF;
               IF l_Wrk_Found  OR l_Prev_Found THEN
                  ...
                  ELSIF (NOT l_wrk_Found)  AND l_Prev_Found THEN
                     l_Rec_Action := 'D';
                  END IF;
                  Pr_Log_Change('DESCRIPTION',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.description,p_Wrk_stdfio11.v_sttms_fiori1_master.description);
Pr_Log_Change('EXPOSURE_CATEGORY',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.exposure_category,p_Wrk_stdfio11.v_sttms_fiori1_master.exposure_category);
Pr_Log_Change('GROUP_CODE',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.group_code,p_Wrk_stdfio11.v_sttms_fiori1_master.group_code);
Pr_Log_Change('GROUP_STATUS',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.group_status,p_Wrk_stdfio11.v_sttms_fiori1_master.group_status);
Pr_Log_Change('GROUP_TYPE',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.group_type,p_Wrk_stdfio11.v_sttms_fiori1_master.group_type);
Pr_Log_Change('SINCE',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.since,p_Wrk_stdfio11.v_sttms_fiori1_master.since);
Pr_Log_Change('MAKER_ID',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.maker_id,p_Wrk_stdfio11.v_sttms_fiori1_master.maker_id);
Pr_Log_Change('MAKER_DT_STAMP',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.maker_dt_stamp,p_Wrk_stdfio11.v_sttms_fiori1_master.maker_dt_stamp);
Pr_Log_Change('CHECKER_ID',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.checker_id,p_Wrk_stdfio11.v_sttms_fiori1_master.checker_id);
Pr_Log_Change('CHECKER_DT_STAMP',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.checker_dt_stamp,p_Wrk_stdfio11.v_sttms_fiori1_master.checker_dt_stamp);
Pr_Log_Change('MOD_NO',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.mod_no,p_Wrk_stdfio11.v_sttms_fiori1_master.mod_no);
Pr_Log_Change('RECORD_STAT',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.record_stat,p_Wrk_stdfio11.v_sttms_fiori1_master.record_stat);
Pr_Log_Change('AUTH_STAT',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.auth_stat,p_Wrk_stdfio11.v_sttms_fiori1_master.auth_stat);
Pr_Log_Change('ONCE_AUTH',l_Rec_Action,p_Prev_stdfio11.v_sttms_fiori1_master.once_auth,p_Wrk_stdfio11.v_sttms_fiori1_master.once_auth);
            ...
            IF NOT stpks_stdfio11_Main.Fn_Skip_custom  THEN
               IF NOT stpks_stdfio11_Custom.Fn_Post_Upload_Db (p_Source,
                  ...
                  p_Err_Code,
                  p_Err_Params) THEN
                  Dbg('Failed in stpks_stdfio11_Custom.Fn_Post_Upload_Db After Logging');
                  RETURN FALSE;
               END IF;
            END IF;
            g_Skip_custom:= l_Skip_custom;
   ...
   RETURN BOOLEAN IS
      ...
      l_stdfio11     stpks_stdfio11_Main.Ty_stdfio11;
   ...
   BEGIN
      ...
      IF NOT  Fn_Get_Key_Information(p_Source,
         ...
         RAISE e_Failure_Exception;
      END IF;
      p_Addl_Info := l_stdfio11.Addl_Info;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others Of stpks_stdfio11_Main.Fn_Get_Node_Data..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   RETURN BOOLEAN IS
      ...
      l_Wrk_stdfio11    stpks_stdfio11_Main.Ty_stdfio11;
      l_Prev_stdfio11    stpks_stdfio11_Main.Ty_stdfio11;
      l_Dmy_stdfio11    stpks_stdfio11_Main.Ty_stdfio11;
   ...
   BEGIN
      ...
      SAVEPOINT Sp_Int_Main_Stdfio11;
      p_Status := 'S';
      g_Tanking_Status := l_Tanking_Status;
      g_stdfio11 := p_stdfio11;
      l_Wrk_stdfio11 := p_stdfio11;
      ...
      IF NOT  Fn_Get_Key_Information(p_Source,
         ...
         RAISE e_Failure_Exception;
      END IF;
      l_Sent_Mod_No := p_stdfio11.v_sttms_fiori1_master.Mod_No;
      ...
      ELSE
         ...
         IF l_Resultant_Error_Type <> 'E' THEN
            ...
            IF  l_Action_Code IN (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen) THEN
               l_Prev_Auth_Stat := NVL(l_Prev_stdfio11.v_sttms_fiori1_master.Auth_Stat,'A') ;
               --Get Upload Status
      ...
      IF l_Action_Code = Cspks_Req_Global.p_Delete AND p_Source = 'FLEXCUBE'  THEN
         l_Wrk_stdfio11 := l_Dmy_stdfio11;
      END IF;
      p_stdfio11 := l_wrk_stdfio11;
      Dbg('Errors     :'||p_Err_Code);
      Dbg('Parameters :'||p_Err_Params);
   ...
   EXCEPTION
      WHEN E_Failure_Exception THEN
         ...
         ROLLBACK TO Sp_Int_Main_Stdfio11;
         p_Status        := 'F';
         l_Post_Upl_Stat := 'F';
         Cspks_Req_Utils.Pr_Get_Final_Err_Code(p_Function_Id,l_Action_Code,l_Post_Upl_Stat,p_Err_Code,p_Err_Params);
         Pr_Log_Error(p_Source,p_Err_Code,p_Err_Params);
